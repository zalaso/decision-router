...
async def run(args):
    ...
    report = {
        ...
        "model": settings.local_model if settings.local_backend != "fake" else "deterministic-v1",
        "revision": settings.local_revision if settings.local_backend != "fake" else None,
